...
// isoWeek / rankLedger: shared house convention, extracted 2026-09-02 to
// ../src/explore/ratingPercentile.ts (also consumed by burstWindowScan.ts
// gradient) — one ranking predicate, two scans.
...
const bucketOfPct = bandOfPct;
const BUCKETS = PCT_BANDS;
