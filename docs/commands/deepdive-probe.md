...
> | `drink`                            | None                                                                         | Both sides' healers' mana-rising segments (start/end, mana gained, whether a damage event landed on that healer during the segment or ≤1s after — note the underlying predicate also catches ordinary in-combat mana regen, not only literal drink-item use) |
>
