...
>    (642)/寒冰屏障(45438)机制上任何被控状态皆可施放(官方 DB2 `SpellMisc.Attributes`
>    位标志,`usableWhileCcGenerated.ts`),不存在"按不出"这回事,原判断有误的结论
>    已定案。**代价规范层的签字册条目已落地**:642/45438 两条 `cost_norm` 已登记进
